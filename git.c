...
static int run_builtin(struct cmd_struct *p, int argc, const char **argv)
{
	...
	if (p->option & ALLOW_SPARSE_INDEX)
		command_requires_full_index = 0;
...
static struct cmd_struct commands[] = {
	{ "add", cmd_add, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "am", cmd_am, RUN_SETUP | NEED_WORK_TREE },
	{ "annotate", cmd_annotate, RUN_SETUP },
	{ "apply", cmd_apply, RUN_SETUP_GENTLY },
	{ "archive", cmd_archive, RUN_SETUP_GENTLY },
	{ "bisect", cmd_bisect, RUN_SETUP },
	{ "blame", cmd_blame, RUN_SETUP | ALLOW_SPARSE_INDEX },
	...
	{ "checkout", cmd_checkout, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "checkout--worker", cmd_checkout__worker,
		RUN_SETUP | NEED_WORK_TREE },
	{ "checkout-index", cmd_checkout_index,
		RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX},
	{ "cherry", cmd_cherry, RUN_SETUP },
	{ "cherry-pick", cmd_cherry_pick, RUN_SETUP | NEED_WORK_TREE },
	{ "clean", cmd_clean, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "clone", cmd_clone },
	{ "column", cmd_column, RUN_SETUP_GENTLY },
	{ "commit", cmd_commit, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	...
	{ "describe", cmd_describe, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "diagnose", cmd_diagnose, RUN_SETUP_GENTLY },
	{ "diff", cmd_diff, NO_PARSEOPT | ALLOW_SPARSE_INDEX },
	{ "diff-files", cmd_diff_files, RUN_SETUP | NEED_WORK_TREE | NO_PARSEOPT | ALLOW_SPARSE_INDEX },
	{ "diff-index", cmd_diff_index, RUN_SETUP | NO_PARSEOPT },
	{ "diff-tree", cmd_diff_tree, RUN_SETUP | NO_PARSEOPT },
	{ "difftool", cmd_difftool, RUN_SETUP_GENTLY },
	{ "fast-export", cmd_fast_export, RUN_SETUP },
	{ "fast-import", cmd_fast_import, RUN_SETUP | NO_PARSEOPT },
	{ "fetch", cmd_fetch, RUN_SETUP | ALLOW_SPARSE_INDEX },
	...
	{ "grep", cmd_grep, RUN_SETUP_GENTLY | ALLOW_SPARSE_INDEX },
	...
	{ "log", cmd_log, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "ls-files", cmd_ls_files, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "ls-remote", cmd_ls_remote, RUN_SETUP_GENTLY },
	{ "ls-tree", cmd_ls_tree, RUN_SETUP },
	{ "mailinfo", cmd_mailinfo, RUN_SETUP_GENTLY },
	{ "mailsplit", cmd_mailsplit, NO_PARSEOPT },
	{ "maintenance", cmd_maintenance, RUN_SETUP },
	{ "merge", cmd_merge, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	...
	{ "pull", cmd_pull, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "push", cmd_push, RUN_SETUP },
	{ "range-diff", cmd_range_diff, RUN_SETUP | USE_PAGER },
	{ "read-tree", cmd_read_tree, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "rebase", cmd_rebase, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	...
	{ "reset", cmd_reset, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "restore", cmd_restore, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "rev-list", cmd_rev_list, RUN_SETUP | NO_PARSEOPT },
	{ "rev-parse", cmd_rev_parse, NO_PARSEOPT | ALLOW_SPARSE_INDEX },
	{ "revert", cmd_revert, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "rm", cmd_rm, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "send-pack", cmd_send_pack, RUN_SETUP },
	{ "shortlog", cmd_shortlog, RUN_SETUP_GENTLY | USE_PAGER },
	{ "show", cmd_show, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "show-branch", cmd_show_branch, RUN_SETUP },
	{ "show-index", cmd_show_index, RUN_SETUP_GENTLY },
	{ "show-ref", cmd_show_ref, RUN_SETUP },
	{ "sparse-checkout", cmd_sparse_checkout, RUN_SETUP | ALLOW_SPARSE_INDEX },
	{ "stage", cmd_add, RUN_SETUP | NEED_WORK_TREE },
	{ "stash", cmd_stash, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "status", cmd_status, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "stripspace", cmd_stripspace },
	{ "submodule--helper", cmd_submodule__helper, RUN_SETUP },
	{ "switch", cmd_switch, RUN_SETUP | NEED_WORK_TREE | ALLOW_SPARSE_INDEX },
	{ "symbolic-ref", cmd_symbolic_ref, RUN_SETUP },
	{ "tag", cmd_tag, RUN_SETUP | DELAY_PAGER_CONFIG },
	{ "unpack-file", cmd_unpack_file, RUN_SETUP | NO_PARSEOPT },
	{ "unpack-objects", cmd_unpack_objects, RUN_SETUP | NO_PARSEOPT },
	{ "update-index", cmd_update_index, RUN_SETUP | ALLOW_SPARSE_INDEX },
	...
	{ "write-tree", cmd_write_tree, RUN_SETUP | ALLOW_SPARSE_INDEX },
};
